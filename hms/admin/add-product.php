...
$sql= "INSERT INTO products(product_name,price)VALUES ('$product_name','$product_price')";
...
<div class="row">
	<div class="col-lg-6">
		<div class="form-group">
							<label for="lastname" class="text-bold">Product Name</label>
							<input type="text" name="productname" class="form-control"  placeholder="Enter Product Name">
		</div>
	</div>
	<div class="col-lg-6">
		<div class="form-group">
							<label for="lastname" class="text-bold">Product Price</label>

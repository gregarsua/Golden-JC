...
$sql = "UPDATE acknowledgements SET status1='$verify' WHERE id='$did'";
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Verify Acknowledgement Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span>Verify Acknowledgement Details</span>
									</li>
								</ol>
							</div>
						</section>
	...
	<form role="form" name="adddoc" method="post" onSubmit="return valid();">
			<div class="col-md-6">
				<div class="form-group">
								<label for="doctorname" class="text-bold">Code:</label>
							<input type="password" name="code" class="form-control" value="<?php echo htmlentities($data['status1']);?>" >
				</div>
                <button type="submit" name="submit" class="btn btn-o btn-primary">VERIFY</button>
            </div>										
<?php } ?>		

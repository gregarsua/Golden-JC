...
if(isset($_GET['del']))
		  {
		          $del = "DELETE FROM staff WHERE id = '".$_GET['id']."'";
...
<html lang="en">
	<head>
		<title>Admin | Staff Login History</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Staff Login History</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>

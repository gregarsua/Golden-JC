...
$sql= "UPDATE users set fullName='$fname',address='$address',city='$city',gender='$gender' where email='".$_SESSION['login']."'";
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									...
									<?php $sql= "SELECT * FROM users WHERE email='".$_SESSION['login']."'";
											$con = mysqli_query($bd,$sql);	

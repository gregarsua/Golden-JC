...
if(isset($_GET['del']))
		  {
		          $del = "DELETE FROM reports WHERE id = '".$_GET['id']."'";
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Report History</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												...
												<th>Cost</th>
												<th>Fee</th>
												<th>Swiped <br />Terminal</th>
												<th>SOA <br />Account</th>
												<th>Collected</th>
										...
										<tbody>
<?php
$sql= "SELECT * FROM reports WHERE admin_name='".$_SESSION['dlogin']."'";
...
?>
											...
											<tr>
												...
												<td><b><?php echo $row['admin_name'];?></b></td>
												<td><b><?php echo $row['numbers'];?></b></td>
												...
												<td><?php echo $row['swipedterminal'];?></td>
